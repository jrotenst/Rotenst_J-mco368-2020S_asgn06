...
/*
	Assignment 6
	Enter your name here: Yossi Rotenstreich
	Due TBD
	60 Points
*/
...
namespace Asgn06
{
    class Program
    {
        static void Main(string[] args)
        {
			...
			/*why not group students by both year and aid status and just count the group size?*/
			...
			/* Question 2
		   Use the GroupBy extension method with a lambda expression to get all students into groups based on how
		   ...
		   ********************************
		   ...
		   CORRECT OUTPUT:
		   ***************
		   The average of all grades for all students is: 2.88081395348837	   
			*/
